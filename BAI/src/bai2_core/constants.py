...
TypeCodes = [
    ...
    TypeCode('403', TypeCodeTransaction.debit, TypeCodeLevel.summary, 'Todays Total Debits'),
    ...
    TypeCode('503', None, TypeCodeLevel.status, 'Available limit'),
    ...
    TypeCode('906', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'National nominees credits - National nominees'),
    TypeCode('905', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Credit Interest - Interest'),
    TypeCode('910', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Cash - Cash'),
    TypeCode('911', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Cash/cheques - Cash/cheques'),
    TypeCode('915', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Agent Credits - Agent number advised'),
    TypeCode('920', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Inter-bank credits - Company’s name (abbreviated)'),
    TypeCode('925', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Bankcard credits - Bankcard'),
    TypeCode('930', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Credit balance transfer - Balance transfer'),
    TypeCode('935', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'Credits summarised - Not applicable'),
    TypeCode('936', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'EFTPOS - Merchant name'),
    TypeCode('938', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'NFCA credit transactions - Not applicable'),
    TypeCode('950', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Loan establishment fees - Establishment fee'),
    TypeCode('951', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Account keeping fees - Account keeping fee'),
    TypeCode('952', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Unused limit fees - Unused limit fee'),
    TypeCode('953', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Security fees - Security fee'),
    TypeCode('955', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Charges - Charge (or description)'),
    TypeCode('956', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'National nominee debits - National nominees'),
    TypeCode('960', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Stamp duty-cheque book - Cheque book'),
    TypeCode('961', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Stamp duty - Stamp duty'),
    TypeCode('962', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Stamp duty-security - Security stamp duty'),
    TypeCode('970', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'State government tax - State government credit tax'),
    TypeCode('971', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Federal government tax - Federal government debit tax'),
    TypeCode('975', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Bankcards - Bankcard'),
    TypeCode('980', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Debit balance transfers - Balance transfers'),
    TypeCode('985', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Debits summarised - Not applicable'),
    TypeCode('986', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Cheques summarised - Not applicable'),
    TypeCode('987', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'Non-cheques summarised - Not applicable'),
    TypeCode('988', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'NFCA debit transaction - Not applicable'),
    TypeCode('965', None, TypeCodeLevel.status, 'Effective Debit interest rate'),
    TypeCode('966', None, TypeCodeLevel.status, 'Effective Credit interest rate'),
    TypeCode('967', None, TypeCodeLevel.status, 'Accrued State Government Duty'),
    TypeCode('968', None, TypeCodeLevel.status, 'Accrued Government Credit Tax'),
    TypeCode('969', None, TypeCodeLevel.status, 'Accrued Government Debit Tax'),
   
]
TypeCodes = {type_code.code: type_code for type_code in TypeCodes}
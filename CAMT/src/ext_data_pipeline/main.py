...
from common.central_validator import CentralValidator, ValidationError
...
def process_camt_file(gcs_path: str):
    ...
    # Transform (removed cust_id parameter)
    transformer = Transformer(org_id, div_id, BALANCE_TABLE_ID, TRANSACTIONS_TABLE_ID)
    ...
    # Apply defaults (pass validator instance)
